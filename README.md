...
edit js/profile-w3c-common.js and comment out any W3C stuff you don't need (the names should be fairly obvious).

npm install
./tools/build-w3c-common.js

I should mention, the custom profile will be located "builds/respec-w3c-common.js"